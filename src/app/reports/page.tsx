...
export default function ReportsPage() {
  ...
  useEffect(() => {
    ...
    if (storedInvoices) {
      setInvoices(JSON.parse(storedInvoices).sort((a: Invoice, b: Invoice) => new Date(b.date).getTime() - new Date(a.date).getTime()));
    }
  }, []);
        ...
        <div className="lg:col-span-1">
          <Card className="sticky top-6">
            ...
            <CardContent className="flex flex-col gap-4 text-center">
              ...
              <div className="text-4xl font-bold font-headline">{invoices.length}</div>
